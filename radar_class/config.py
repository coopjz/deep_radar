...
region = \
    {
        ...
        # red base only for enemy 1
        'm_l_red_base_r': [5.500, 9.700, 5.500, 5.300, 0.500],
        # blue base only for enemy 0
        'm_l_blue_base_l': [22.500, 9.700, 22.500, 5.300, 0.500],
        ...
        # enemy case, only alarm
        'm_r_red_dafu_a': [7.718, 2.532, 9.130, 1.315, 0.945, 0.],
        # only enemy case, only alarm
        'm_r_red_feipopre_a': [2.855, 3.516, 4.184, 0.000, 0.4, 0.],
        ...
        # xinjiapo
        'm_fp_blue_gaodipre_d': [17.579, 10.446, 19.040, 8.279, 17.579, 7.817, 16.386, 9.643, 0., 0.6],
        # every case, send and alarm : send to 1,3,4,5 TASK 2
        'm_fp_red_gaodipre2_a': [13.531, 13.906, 11.497, 11.211, 10.559, 11.836, 12.318, 14.492, 0., 0.],
        # goubipo
        'm_fp_blue_gaodipre2_a': [17.441, 3.164, 15.682, 0.508, 14.469, 1.094, 16.503, 3.789, 0., 0.],
...
if test:
    ...
    PC_RECORD_SAVE_DIR = "/home/cooper/Documents/RM2023-Deep-Radar/demo_resource/demo_pc.pkl"  # 点云存放位置
    real_size = (28., 15.)
    main_region = region
    debug = True
    using_video = True  # 测试是否用视频
    VIDEO_PATH = "/home/cooper/Documents/RM2023-Deep-Radar/demo_resource/two_cam"
    THIRD_VIDEO_PATH = "/home/cooper/Documents/RM2023-Deep-Radar/demo_resource/third_cam.mp4"
else:  # default
    home_test = False
    using_dq = False
...
enemy_case = ["diaoshe", 'dafu', 'feipopre', 'feipo',
              'missilelaunch1', "missilelaunch2"]  # 这些区域在预警时只考虑敌方的该区域

armor_list = ['R1', 'R2', 'R3', 'R4', 'R5', 'B1',
              'B2', 'B3', 'B4', 'B5']  # 雷达站实际考虑的各个装甲板类

unit_list = ['R1', 'R2', 'R3', 'R4', 'R5', 'RG', 'RO', 'RB', 'B1',
             'B2', 'B3', 'B4', 'B5', 'BG', 'BO', 'BB']  # 赛场上各个目标，主要用于HP显示
